...
Original file is located at
    https://colab.research.google.com/drive/1iLMEpn60MN1g_xOSuJ2Hisbsq1AW95mL
"""

!git clone "https://github.com/BhavikPawar29/Advanced-Java-MicroProject"
...
!python /content/Advanced-Java-MicroProject//src/main.py

!ls "/content/drive/My Drive/Pins"
...
data_sequences, df_data = read_fasta(r"/content/drive/MyDrive/Pins/GCF_000001405.40_GRCh38.p14_genomic.fna", chunk_size=1000)

df_features = read_gff(r"/content/drive/MyDrive/Pins/genomic.gff")
...
def _encodeLabels(self, y_train):
        ...
        # Encode labels using LabelEncoder
        y_train_annotation_encoded = label_encoder.fit_transform(y_train)
...
def trainModel(x_train, y_train, epochs, batch_size, task=None):
    ...
    y_train_annotation_encoded, num_classes = _encodeLabels(y_train_prediction)

    model = build_model(input_shape, num_classes, learning_rate=0.001)
...
if __name__ == "__main__":
    ...
    data, edge_index, x, kmer_to_vertex = DeBruijnGNN.de_novo_assembly(data_sequences)

    # Train the DeBruijnGNN model
    trained_model = DeBruijnGNN.train_gnn(data, edge_index, x)

    # Make predictions using the trained model
    assembled_genome = DeBruijnGNN.predict(data_sequences, trained_model, data, kmer_to_vertex)
